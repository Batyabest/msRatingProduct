...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('msratingproduct_core_path', null,
                    $modx->getOption('core_path') . 'components/msratingproduct/') . 'model/';
            $modx->addPackage('msratingproduct', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/msratingproduct/model/schema/msratingproduct.mysql.schema.xml';
